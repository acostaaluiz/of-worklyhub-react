...
- `VITE_BILLING_DEV_BYPASS_GATEWAY_DEVELOP` / `VITE_BILLING_DEV_BYPASS_GATEWAY_MASTER` (opcional)
- `VITE_FIREBASE_API_KEY_DEVELOP` / `VITE_FIREBASE_API_KEY_MASTER` (opcional)
- `VITE_FIREBASE_AUTH_DOMAIN_DEVELOP` / `VITE_FIREBASE_AUTH_DOMAIN_MASTER` (opcional)
- `VITE_FIREBASE_PROJECT_ID_DEVELOP` / `VITE_FIREBASE_PROJECT_ID_MASTER` (opcional)
- `VITE_FIREBASE_STORAGE_BUCKET_DEVELOP` / `VITE_FIREBASE_STORAGE_BUCKET_MASTER` (opcional)
- `VITE_FIREBASE_MESSAGING_SENDER_ID_DEVELOP` / `VITE_FIREBASE_MESSAGING_SENDER_ID_MASTER` (opcional)
- `VITE_FIREBASE_APP_ID_DEVELOP` / `VITE_FIREBASE_APP_ID_MASTER` (opcional)
